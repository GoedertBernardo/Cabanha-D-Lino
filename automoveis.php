...
$dadosJson = file_get_contents('automoveis.json');
                ...
                <div class="grid-carros">
                    ...
                    <?php foreach ($veiculos as $veiculo): ?>
                        <div class="card-carro">
                            ...
                            <h3><?php echo strtoupper($veiculo['marca'] . ' ' . $veiculo['modelo']); ?></h3>
                            ...
                            <a href="detalhes.php?id=<?php echo $veiculo['id']; ?>&categoria=carros" class="btn-comprar">Ver detalhes</a>
                        </div>
                    <?php endforeach; ?>
