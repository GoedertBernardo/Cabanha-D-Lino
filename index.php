...
$dadosJson = file_get_contents('destaques.json');
...
<body>
    <header>
        ...
        <div class="admin-icon">
            <a href="login.php"><button><i class="bi bi-person-gear"></i></button></a>
        </div>
                ...
                <div class="grid-carros">
                    ...
                    <?php foreach ($veiculos as $veiculo): ?>
                        <div class="card-carro">
                            ...
                            <a href="detalhes.php?id=<?php echo $veiculo['id']; ?>" class="btn-comprar">Ver detalhes</a>
                        </div>
                    <?php endforeach; ?>

                </div>
            </div>
            <a href="automoveis.php" class="btn-vertodos">Ver todos</a>
        </section>
    </header>
</body>
<footer class="rodape">
